...
import {getBasketCustomerById, deleteProductFromBasket ,recommendProductFromBasket,incrementProductFromBasket,decrementProductFromBasket} from "../services/BasketService.js";

import {routes} from "../routes/Routes.js";
import {useNavigate} from "react-router-dom";
import RecommendedProducts from "../components/RecommendedProductsSlider.jsx";
import RecommendedProductsSlider from "../components/RecommendedProductsSlider.jsx";
...
const Basket = () => {
    ...
    useEffect(() => {
        ...
        recommendProductFromBasket(basket)
    }, [basket]);
    ...
    return (
        <div className="max-w-7xl mx-auto p-4">
            ...
            <RecommendedProductsSlider basket={basket} />
        </div>
    );
};
