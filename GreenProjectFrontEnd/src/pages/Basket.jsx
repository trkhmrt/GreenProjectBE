...
const Basket = () => {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#ece9f7] via-[#f8f6fc] to-[#e3d6ff]">
    ...
    if (basket.length === 0) {
        return (
            <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#ece9f7] via-[#f8f6fc] to-[#e3d6ff] py-8 px-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 text-center max-w-md w-full border border-[#ece6f7]">
                    <div className="mb-6">
                        <svg className="w-16 h-16 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                        </svg>
                        <h2 className="text-xl font-semibold text-gray-800 mb-2">Sepetiniz Boş</h2>
                        <p className="text-gray-600">Alışverişe başlamak için ürünleri keşfedin</p>
                    </div>
                    <button
                        onClick={() => navigate("/")}
                        className="w-full py-3 rounded-xl bg-[#6C2BD7] text-white font-bold text-lg shadow hover:bg-[#4B1C8C] transition-all duration-200"
                    >
                        Alışverişe Başla
                    </button>
                </div>
