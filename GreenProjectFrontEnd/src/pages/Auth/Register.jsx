            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-gradient-to-br from-purple-50/30 to-purple-100/20 backdrop-blur-sm rounded-2xl border border-purple-200/30 p-8 shadow-xl">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-purple-800 mb-2">Kayıt Ol</h1>
                        <p className="text-purple-600 text-sm">Yeni hesap oluşturun</p>
                    </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-purple-700 mb-2">Ad</label>
                                <input
                                    type="text"
                                    name="firstName"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-purple-700 mb-2">Soyad</label>
                                <input
                                    type="text"
                                    name="lastName"
                        ...
                        {/* Email Field */}
                        <div>
                            <label className="block text-sm font-medium text-purple-700 mb-2">E-posta</label>
                            <input
                                type="email"
                                name="email"
                        ...
                        <div className="relative">
                            <label className="block text-sm font-medium text-purple-700 mb-2">Şifre Tekrar</label>
                            <div className="relative">
                                <input
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-purple-600 text-sm">
                            ...
                            <a href="/login" className="text-purple-700 hover:text-purple-800 font-medium transition-colors duration-200 hover:underline">
                                Giriş Yap
                            </a>
                        </p>
                    </div>
